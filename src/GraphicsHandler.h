...
typedef struct VulkanInfo {
	...
	VkRenderPass primaryrenderpass, templateshadowrenderpass, ssrrrenderpass;
	...
	TextureInfo depthbuffer, * ssrrbuffers, ssrrdepthbuffer; // trying single buf w/ depth, if it works do the same w/ color and refactor name
